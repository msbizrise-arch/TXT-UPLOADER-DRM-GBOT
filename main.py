...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="Join Channel🥀", url="https://t.me/Lapata_official")]])
keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="Help🤝", url="https://t.me/TeamMT_Robot"), InlineKeyboardButton(text="OWNER👀", url="https://t.me/SmartBoy_ApnaMS")],
])

# Image URLs for the random image feature
image_urls = [
    "https://graph.org/file/f58d5d9a4f94fa0ad7fcc-cc2d3b41ecd9b5cbd1.jpg",
    "https://graph.org/file/dfd9fe56e29f41b74900f-485e4dda0b2475b549.jpg", 
    "https://graph.org/file/68274e0b2f05b867c91ba-3b6af9907eb00727e4.jpg",
...
async def add_auth_user(client: Client, message: Message):
    if message.chat.id != OWNER:
        return await message.reply_text("**SORRY THIS ONLY FOR MY OWNER**")
...
async def txt_handler(bot: Client, m: Message):  
    ...
    await editable.edit(f"**🔹Enter Batch Name or send /mahi for use default**")
    try:
    ...
    await editable.edit(f"**🔹Enter Your Name or send /ms for use default**")
    try:
    ...
    await editable.edit("**🔹Enter PW/CP/CW Working Token For 𝐌𝐏𝐃 𝐔𝐑𝐋 or send /vip**")
    try:
    ...
    await editable.edit(f"**🔹Send the Video Thumb URL or send /pro for use default**")
    try:
